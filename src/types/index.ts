...
export type HomePageSection =
  ...
  | (BeforeAfterSection & BaseSectionType & { _type: "beforeAfterSection" });
...
export type ComponentPropsMap = {
  ...
  conversationSection: {
    data: ConversationSection &
      BaseSectionType & { _type: "conversationSection" };
    onViewChange?: () => void;
  };
  experiencingSection: {
    data: ExperiencingSection &
      BaseSectionType & { _type: "experiencingSection" };
  };
  reasonSection: {
    data: ReasonSection & BaseSectionType & { _type: "reasonSection" };
  };
  currentEditionPeopleSection: {
    data: CurrentEditionPeopleSection &
      BaseSectionType & { _type: "currentEditionPeopleSection" };
  };
  successCaseSection: {
    data: SuccessCaseSection &
      BaseSectionType & { _type: "successCaseSection" };
  };
  aboutMeSection: {
    data: AboutMeSection & BaseSectionType & { _type: "aboutMeSection" };
  };
  howReservationWorksSection: {
    data: HowReservationWorksSection &
      BaseSectionType & { _type: "howReservationWorksSection" };
  };
  warrantySection: {
    data: WarrantySection & BaseSectionType & { _type: "warrantySection" };
  };
...
export type GetComponentProps<T extends keyof ComponentPropsMap> =
  ComponentPropsMap[T];
...
export function isConversationSection(
  section: HomePageSection
): section is ConversationSection &
  BaseSectionType & { _type: "conversationSection" } {
  return section._type === "conversationSection";
}

export function isExperiencingSection(
  section: HomePageSection
): section is ExperiencingSection &
  BaseSectionType & { _type: "experiencingSection" } {
  return section._type === "experiencingSection";
}

export function isReasonSection(
  section: HomePageSection
): section is ReasonSection & BaseSectionType & { _type: "reasonSection" } {
  return section._type === "reasonSection";
}

export function isCurrentEditionPeopleSection(
  section: HomePageSection
): section is CurrentEditionPeopleSection &
  BaseSectionType & { _type: "currentEditionPeopleSection" } {
  return section._type === "currentEditionPeopleSection";
}

export function isSuccessCaseSection(
  section: HomePageSection
): section is SuccessCaseSection &
  BaseSectionType & { _type: "successCaseSection" } {
  return section._type === "successCaseSection";
}

export function isAboutMeSection(
  section: HomePageSection
): section is AboutMeSection & BaseSectionType & { _type: "aboutMeSection" } {
  return section._type === "aboutMeSection";
}

export function isHowReservationWorksSection(
  section: HomePageSection
): section is HowReservationWorksSection &
  BaseSectionType & { _type: "howReservationWorksSection" } {
  return section._type === "howReservationWorksSection";
}

export function isWarrantySection(
  section: HomePageSection
): section is WarrantySection & BaseSectionType & { _type: "warrantySection" } {
...
export function isPriceSection(
  section: HomePageSection
): section is PriceSection & BaseSectionType & { _type: "priceSection" } {
