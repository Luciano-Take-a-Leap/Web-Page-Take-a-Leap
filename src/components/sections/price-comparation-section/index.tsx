...
const PriceComparationSection: React.FC<PriceComparationSectionProps> = ({
  ...
  return (
    <section 
      ref={sectionRef}
      className="w-full bg-white flex justify-center items-center z-20 overflow-hidden"
    >
      <motion.div 
      ...
      >
        ...
        <motion.div 
          className="my-4 md:my-10 w-full max-w-[1200px] flex flex-col items-center justify-center mx-auto shadow-lg md:shadow-2xl rounded-2xl md:rounded-4xl py-4 md:py-6 px-2 md:px-4 gap-4 md:gap-6"
          variants={itemVariants}
        >
          <motion.div 
            ...
            <>
                ...
                <table className="w-full border-collapse">
                  <thead>
                    <motion.tr
                      ...
                      animate={isTableInView ? { opacity: 1, y: 0 } : { opacity: 0, y: -10 }}
                      ...
                      <th className="p-4 text-center font-bold font-montserrat text-lg md:text-xl">
                        {data?.firstColTitle?.image ? (
                          <motion.div
                            ...
                            animate={isTableInView ? { scale: 1, opacity: 1 } : { scale: 0.8, opacity: 0 }}
                  ...
                  <tbody>
                        ...
                        <tr key={`divider-${index}`}>
                          <td colSpan={3} className="p-0">
                            <motion.figure 
                              ...
                              initial={{ scaleX: 0 }}
                              animate={isTableInView ? { scaleX: 1 } : { scaleX: 0 }}
                    ...
                    <motion.tr
                      ...
                      className="hover:bg-gray-50 transition-colors"
                      initial={{ opacity: 0, y: 20 }}
                      animate={isTableInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
              ...
              >
                ...
                <motion.div 
                  ...
                  animate={isMobileInView ? { scale: 1, opacity: 1 } : { scale: 0.9, opacity: 0 }}
