...
import { ReasonSection as TReasonSection } from '@studio/sanity.types';
  ...
  return (
    ...
    >
      <div className="w-full md:w-[80%] z-10">
        <motion.h2
          className="text-2xl md:text-[40px] mb-4 font-lora font-bold tracking-[0.2px] w-full lg:w-[85%] relative"
        ...
        >
          <div className="lg:w-[50%] flex flex-col justify-center text-sm text-black lg:pt-20 gap-8 relative z-20">
            {isInView ? (
              <RichText
                value={data?.content}
                animate
      ...
      >
       ...
       <Image
          ...
          width={390}
          height={180}
          className="absolute bottom-0 left-0 transform translate-x-[5%] translate-y-[5%] hidden lg:block scale-75 rotate-60"
          style={{
            filter:
